...
export default function TeamSettingsLayout({
  ...
  const items = [
    { name: t('menu.personalAccount'), href: `/${accountSlug}/settings` },
    { name: t('menu.teams'), href: `/${accountSlug}/settings/members` },
    ...(billingUiEnabled ? [{ name: t('menu.billing'), href: `/${accountSlug}/settings/billing` }] : []),
  ];
  return (
