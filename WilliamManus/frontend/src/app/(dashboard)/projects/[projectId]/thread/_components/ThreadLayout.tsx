...
interface ThreadLayoutProps {
  ...
  streamingText?: string; // Live JSON arguments from tool call chunk for streaming file content
}
...
export function ThreadLayout({
  ...
  return (
    <div className="flex h-screen">
      ...
      <div
        className={`flex flex-col flex-1 overflow-hidden transition-[margin-right] duration-200 ease-in-out ${(!initialLoadCompleted || (isSidePanelOpen && !isActuallyMobile))
