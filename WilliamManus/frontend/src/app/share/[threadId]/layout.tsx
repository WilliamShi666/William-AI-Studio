...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Roys Alpha',
    description: 'Replay this Agent conversation on Roys Alpha',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Roys Alpha';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Roys Alpha';
