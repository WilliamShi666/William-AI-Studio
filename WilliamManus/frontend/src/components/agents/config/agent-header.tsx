...
export function AgentHeader({
  ...
  const { t } = useLanguage();
  const displayName = displayData.name === 'Suna' ? t('agent.default') : displayData.name;
        ...
        <div className="min-w-0">
          {isEditing ? (
            ...
            <div
              ...
              title={isNameEditable ? `Click to rename agent: ${displayName}` : `Name cannot be edited: ${displayName}`}
            >
              {displayName}
            </div>
          )}
