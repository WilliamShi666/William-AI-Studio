...
const MarketplaceActions: React.FC<{ 
  ...
  const displayName = data.name === 'Suna' ? t('agent.default') : data.name;
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "<strong>{displayName}</strong>"? This will permanently remove it from the marketplace and cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
    ...
    <div className={cardClassName} onClick={() => onClick?.(data)}>
      ...
      <div className="relative p-6 flex flex-col flex-1">
        <div className="flex items-start justify-between mb-4">
          <CardAvatar isSunaAgent={isSunaAgent} profileImageUrl={(data as any)?.profile_image_url} agentName={displayName} />
