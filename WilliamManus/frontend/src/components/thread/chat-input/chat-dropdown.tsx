            ...
            <DropdownMenuTrigger asChild>
                ...
                >
                    <div className="flex items-center gap-2">
                        <Image src="/kortix-symbol.svg" alt="Roys Alpha" width={16} height={16} className="h-4 w-4 dark:invert" />
                        <span>Roys Alpha</span>
            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <span className="font-semibold text-sm">Roys Alpha</span>
