  ...
  return (
    ...
    >
      ...
      >
        ...
        {task.assignee && (
          <span className="text-[10px] px-1.5 py-0.5 rounded bg-[color:color-mix(in_srgb,var(--app-accent)_10%,transparent)] text-[color:var(--app-accent-hover)] border border-[color:color-mix(in_srgb,var(--app-accent)_20%,transparent)] flex-shrink-0">
            {task.assignee}
          </span>
        )}
        {task.priority && (
