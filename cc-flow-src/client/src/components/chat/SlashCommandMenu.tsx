              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 w-full px-4 py-2 text-left transition-all ${
                    isSelected
                      ? "bg-[color:color-mix(in_srgb,var(--app-accent)_12%,transparent)] border-l-2 border-[color:var(--app-accent)]"
                      : "border-l-2 border-transparent hover:bg-white/5"
                  }`}
                >
                  <span className={`flex-shrink-0 ${isSelected ? "text-[color:var(--app-accent-hover)]" : "text-slate-500"}`}>
                    {cmd.icon}
                  </span>
