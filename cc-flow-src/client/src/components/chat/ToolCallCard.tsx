...
const TOOL_META: Record<string, {
  ...
  Bash:      { Icon: Terminal,   label: "Bash",       color: "text-[color:var(--app-accent-hover)] border-[color:color-mix(in_srgb,var(--app-accent)_20%,transparent)] bg-[color:color-mix(in_srgb,var(--app-accent)_5%,transparent)]" },
...
const OP_COLORS: Record<string, { label: string; color: string }> = {
  ...
  M: { label: "MOVE",   color: "text-[color:var(--app-accent-hover)]" },
          ...
          <div className="flex items-center gap-2">
            ...
            {permData?.hasSuggestions && (
              <button
                ...
                className="px-2.5 py-1 text-[11px] font-medium rounded-md border border-[color:color-mix(in_srgb,var(--app-accent)_30%,transparent)] text-[color:var(--app-accent-hover)] hover:bg-[color:color-mix(in_srgb,var(--app-accent)_10%,transparent)] transition-colors"
              >
                总是允许
              </button>
            )}
