      ...
      <div className="px-3 py-1.5">
        <div className="relative">
          ...
          <input
            ...
            placeholder="搜索文件..."
            className="w-full text-xs bg-white/[0.03] border border-white/8 rounded-md pl-7 pr-2 py-1.5 text-slate-200 placeholder-slate-500 focus:outline-none focus:border-[color:color-mix(in_srgb,var(--app-accent)_30%,transparent)]"
          />
        </div>
      </div>
