      ...
      <div className="p-3 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-[color:color-mix(in_srgb,var(--app-accent)_10%,transparent)] text-[color:var(--app-accent-hover)]">
              {typeLabel}
            </span>
    ...
    <div className="p-3 space-y-3">
      ...
      <div>
        ...
        >
          ...
          <Brain size={12} className="text-[color:var(--app-accent-hover)]" />
        ...
        {autoMemoryOpen && (
          <div className="mt-2 space-y-1.5 pl-1">
            ...
            {memoryIndex ? (
              <FileCard
                icon={<Brain size={11} className="text-[color:var(--app-accent-hover)]" />}
                name="MEMORY.md"
            ...
            <div>
              ...
              {userRules.length === 0 ? (
                ...
                userRules.map((r) => (
                  <FileCard
                    key={`user-${r.name}`}
                    icon={<ScrollText size={11} className="text-[color:var(--app-accent-hover)]" />}
                    name={r.name}
                    detail={`${r.lineCount} 行`}
