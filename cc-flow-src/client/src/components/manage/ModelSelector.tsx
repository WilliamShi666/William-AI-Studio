...
export default function ModelSelector() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <Brain size={13} className="text-[color:var(--app-accent-hover)]" />
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-72 rounded-xl bg-obsidian-800 border border-obsidian-600/50 shadow-2xl shadow-black/40 overflow-hidden z-50">
          {/* Ambient glow */}
          <div className="absolute -top-12 -right-12 w-24 h-24 bg-[color:color-mix(in_srgb,var(--app-accent)_5%,transparent)] rounded-full blur-2xl" />
