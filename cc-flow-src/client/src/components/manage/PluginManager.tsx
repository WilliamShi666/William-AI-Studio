...
const SCOPE_BADGE: Record<string, { bg: string; text: string; label: string }> = {
  user:    { bg: "bg-[color:color-mix(in_srgb,var(--app-accent)_14%,transparent)]", text: "text-[color:var(--app-accent-hover)]", label: "用户级" },
  project: { bg: "bg-[color:var(--app-control)]", text: "text-[color:var(--app-text-muted)]", label: "项目级" },
  local:   { bg: "bg-[color:var(--app-control)]", text: "text-[color:var(--app-text-subtle)]", label: "本地" },
};
                    ...
                    >
                      ...
                      <div className="max-h-[200px] overflow-y-auto py-1">
                        {suggestions.map((s, i) => (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              <Package size={11} className="flex-shrink-0 text-[color:var(--app-accent-hover)]" />
              ...
              {plugins.map((p) => (
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                      <Package size={13} className="text-[color:var(--app-accent-hover)]" />
