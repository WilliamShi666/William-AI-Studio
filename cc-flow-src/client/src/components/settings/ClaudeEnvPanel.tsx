      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/10 bg-black/20 px-3 py-2 text-xs text-slate-200 placeholder-slate-600 focus:outline-none focus:border-[color:color-mix(in_srgb,var(--app-accent)_40%,transparent)] transition-colors font-mono"
          />
        </div>
  ...
  if (!claudeInfo?.installed) {
    return (
      <div className="space-y-6">
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            <Shield size={14} className="text-[color:var(--app-accent-hover)]" />
            <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
              安装 Claude Code
            </span>
            <span className="ml-1 px-1.5 py-0.5 rounded text-[10px] font-bold bg-[color:color-mix(in_srgb,var(--app-accent)_10%,transparent)] text-[color:var(--app-accent-hover)] border border-[color:color-mix(in_srgb,var(--app-accent)_20%,transparent)]">
              第 2 步
            </span>
          </div>
