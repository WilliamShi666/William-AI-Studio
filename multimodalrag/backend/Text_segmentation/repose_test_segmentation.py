...
def chunk_markdown_api_from_json(json_file_path, api_url=None):
    api_url = api_url or os.getenv("CHUNK_API_URL", "http://localhost:8001/chunk")
    """
...
def main():
    ...
    # API地址
    api_url = os.getenv("CHUNK_API_URL", "http://localhost:8001/chunk")
